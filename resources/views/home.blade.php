...
<!-- title -->
    ...
    <div class="d-flex justify-content-center pt-5" style="font-size: 1.2rem;">
        <div class="card d-flex border border-0" style="max-width:auto;">
            <div class="row g-0 ">
                <div class="col-md-4 pt-4 mt-4">
                    <img src="{{ asset('img/IMG_4834.JPG') }}" class="img-fluid " style="width: 240px; height:240px;" alt="...">
                </div>
                <div class="col-md-8 d-flex align-items-center">
                    <div class="card-body ">
                        ...
                        <div class="" style="line-height: 1;">
                            ...
                            <p>　　　　愛知県名古屋市育ち</p>
                            <p>趣味：刺繍・読書・映画鑑賞</p>
                            <p>学習歴 : 2023年9月末~2024年3月末迄 TECH.I.S.にてWEBシステム開発</br>を学習し、
                            現在はUdemyでLaravelのECサイトや基本情報技術者試験の学習中です。</p>
                        </div>
        ...
        <!-- ポートフォリオ　１件目 -->
    <div class="contents mb-5" style="font-size: 1.2rem;">
